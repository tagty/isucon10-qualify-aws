...
var mySQLConnectionDataEstate, mySQLConnectionDataChair *MySQLConnectionEnv
...
func NewMySQLConnectionEnvEstate() *MySQLConnectionEnv {
	return &MySQLConnectionEnv{
		Host:     getEnv("MYSQL_HOST_ESTATE", "54.249.178.112"),
...
func NewMySQLConnectionEnvChair() *MySQLConnectionEnv {
	return &MySQLConnectionEnv{
		Host:     getEnv("MYSQL_HOST_CHAIR", "3.112.48.202"),
		Port:     getEnv("MYSQL_PORT", "3306"),
		User:     getEnv("MYSQL_USER", "isucon"),
		DBName:   getEnv("MYSQL_DBNAME", "isuumo"),
		Password: getEnv("MYSQL_PASS", "isucon"),
...
func searchEstateNazotte(c echo.Context) error {
	...
	estatesInPolygon := []Estate{}
	query := fmt.Sprintf(`SELECT * FROM estate WHERE ST_Contains(ST_PolygonFromText(%s), point) ORDER BY popularity_desc, id LIMIT %d`, coordinates.coordinatesToText(), NazotteLimit)
